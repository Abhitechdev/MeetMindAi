        ...
        <div className="flex h-16 items-center justify-between">
                ...
                return (
                  <Link
                    ...
                    className={`relative px-3 py-2 text-sm font-medium transition-all duration-300 rounded-md ${
                      isActive ? "text-foreground bg-foreground/5 shadow-sm" : "text-muted hover:text-foreground hover:bg-foreground/5"
                    }`}
                  >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="md:hidden relative">
              ...
              <div
                className={`absolute right-0 top-full mt-2 w-48 rounded-xl border border-card-border bg-surface/95 backdrop-blur-xl p-2 shadow-2xl z-50 flex flex-col gap-1 transition-all duration-200 origin-top-right ${
