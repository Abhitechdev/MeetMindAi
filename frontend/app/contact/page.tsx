...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoSubject = encodeURIComponent(`[MeetMind AI] ${form.subject || "General Inquiry"}`);
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        >
          ...
          >
            ...
            <div>
              <p className="text-xs text-muted font-medium uppercase tracking-wider">Email us anytime</p>
