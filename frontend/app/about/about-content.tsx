        ...
        >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-sm text-muted leading-relaxed">
                MeetMind AI is an independent software tool built to provide privacy-first meeting intelligence. All content, comparative guides, and product documentation are published directly by founder and developer Abhishek. We do not accept sponsored placements or paid product reviews.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-muted space-y-2 ml-2">
                <li><strong className="text-foreground">Human Engineering Review:</strong> All architecture guides and comparison matrices are reviewed directly by our founding developer.</li>
                <li><strong className="text-foreground">Fact-Checking:</strong> Product capabilities (both ours and external tools) are verified using official documentation, API references, and documented feature sets.</li>
                <li><strong className="text-foreground">Transcript Grounding:</strong> Meeting summaries and AI chat responses are strictly grounded in your uploaded audio transcript to minimize hallucinations. Users are encouraged to review AI-generated notes against source recordings.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted leading-relaxed">
                We welcome feedback, corrections, and questions regarding our editorial content or privacy practices. You can reach our editorial email directly at:
              </p>
