...
What we do not claim: we are not a local-only solution. Our processing currently happens on cloud infrastructure. If your requirements demand that audio never leaves your own hardware, a fully local deployment on your own servers may be more appropriate.
