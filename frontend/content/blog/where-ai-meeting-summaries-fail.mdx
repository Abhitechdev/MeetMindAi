...
- **Editable Markdown & Action Items:** Users can instantly copy or export extracted tasks in `.md` and `.txt` format, modifying them before sharing to team boards.
- **Timestamped Transcript Verification:** Reviewers can inspect discrete, timestamped transcript segments to verify ambiguous statements against the verbatim text.
